...
x[1] # first value of the vector.

newobject <- x < 5; newobject # for every element it will print true or false
...
# 4. vector of 1,2,3 : repeat the vector to get 11 x 1, 10 x 2, and 10 x 3  --> means 11 times 1 , 10 times 2 and 10 times 3
...
# FOR loops allow a certain operation to be repeated a fixed no of times
# This is opposed to the While loop where the rep no is not prefixed
