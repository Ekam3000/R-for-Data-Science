...
#Use mtcars dataset, tibble package and dplyr library
#****************************************************
library(dplyr)
...
#Use of filter() 
#************************************************************************
#filter helps subset rows that match certain criteria. The first argument is the name of the
#data.frame and the second (and subsequent) arguments are the criteria that filter the data
#************************************************************************
filter(mtcars_tbl, cyl == 4)

#We can pass multiple criteria separated by a comma. To subset the cars which have either 4 
#or 6 cylinders - cyl and have 5 gears - gear
filter(mtcars_tbl, cyl == 4 | cyl == 6, gear == 5)

#Use of slice() 
#************************************************************************
#Filter selects rows based on criteria, to select rows by position, use slice. slice takes only
#2 arguments: the first one is a data.frame and the second is integer row values.
#Example: To select rows 6 through 9:
#************************************************************************
slice(mtcars_tbl, 6:9)

#Use of arrange() 
#************************************************************************
#Arrange is used to sort the data by a specified variable(s). Just like the previous verb (and
#all other functions in dplyr), the first argument is a data.frame, and consequent arguments 
#are used to sort the data. If more than one variable is passed, the data is first sorted by 
